minetest.register_craftitem("blast_furnace:renforced_gold_ingot", {
	description = "Gold Ingot Renforced",
	inventory_image = "blast_furnace_gold_renforced.png"
})

minetest.register_craft({
	output = "blast_furnace:renforced_gold_ingot",
	recipe = {
		{"default:gold_ingot", "default:bronze_ingot"},
		{"default:bronze_ingot", "default:gold_ingot"},
	}
})
...
src_time = src_time + elapsed * 2

local fuel_totaltime = meta:get_float("fuel_totaltime") or 0
fuel_totaltime = fuel_totaltime - elapsed * 2
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = default.get_blast_furnace_active_formspec(fuel_percent, item_percent)
		swap_node(pos, "blast_furnace:blast_furnace_active")
		-- make sure timer restarts automatically
		result = true

		-- Play sound every 2 seconds while the furnace is active
		if timer_elapsed == 0 or (timer_elapsed + 1) % 2 == 0 then
		...
		formspec = default.get_blast_furnace_inactive_formspec()
		swap_node(pos, "blast_furnace:blast_furnace")
	...
	local infotext
	if active then
		infotext = S("Blast Furnace active")
	else
		infotext = S("Blast Furnace inactive")
	end
...
minetest.register_node("blast_furnace:blast_furnace", {
	...
	on_blast = function(pos)
		...
		drops[#drops+1] = "blast_furnace:blast_furnace"
...
minetest.register_node("blast_furnace:blast_furnace_active", {
	...
	paramtype2 = "facedir",
	light_source = 16,
	drop = "blast_furnace:blast_furnace",
...
minetest.register_craft({
	...
	recipe = {
		{"blast_furnace:renforced_gold_ingot", "group:stone", "blast_furnace:renforced_gold_ingot"},
		{"blast_furnace:renforced_gold_ingot", "default:furnace", "blast_furnace:renforced_gold_ingot"},
		{"blast_furnace:renforced_gold_ingot", "group:stone", "blast_furnace:renforced_gold_ingot"},
	}
})
